...
\centering
\vspace{2cm}
\textbf{Database Schema Diagram}\\
\vspace{0.5cm}
\textit{Comprehensive ERD showing relationships between all database tables including Users, Appointments, Patient Records, ARV Treatments, Notifications, and system audit tables with proper foreign key constraints and normalization}\\
\vspace{0.5cm}
\textit{Dimensions: 14" x 10"}\\
\vspace{0.5cm}
...
% Placeholder for authentication class diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{Authentication System Class Diagram}\\
\vspace{0.5cm}
\textit{UML class diagram showing SecurityConfig, JwtUtils, CustomUserDetailsService, and related classes}\\
\vspace{0.5cm}
\textit{Dimensions: 10" x 8"}\\
\vspace{0.5cm}
\textit{Generated from: authentication\_class\_diagram.plantuml}\\
\vspace{2cm}
\end{minipage}
}
...
\centering
\vspace{2cm}
\textbf{User Authentication Sequence Diagram}\\
\vspace{0.5cm}
\textit{Sequence diagram showing login flow from frontend to backend with JWT token generation}\\
\vspace{0.5cm}
\textit{Dimensions: 12" x 6"}\\
\vspace{0.5cm}
\textit{Generated from: authentication\_sequence.mermaid}\\
\vspace{2cm}
\end{minipage}
}
...
% Placeholder for appointment management class diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{Appointment Management Class Diagram}\\
\vspace{0.5cm}
\textit{UML class diagram showing AppointmentController, AppointmentService, and related entities}\\
\vspace{0.5cm}
\textit{Dimensions: 12" x 10"}\\
\vspace{0.5cm}
\textit{Generated from: appointment\_class\_diagram.plantuml}\\
\vspace{2cm}
\end{minipage}
}
...
% Placeholder for appointment booking sequence diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{Appointment Booking Sequence Diagram}\\
\vspace{0.5cm}
\textit{Sequence diagram showing complete appointment booking flow with validation and notification}\\
\vspace{0.5cm}
\textit{Dimensions: 14" x 8"}\\
\vspace{0.5cm}
...
% Placeholder for notification system class diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{Notification System Class Diagram}\\
\vspace{0.5cm}
\textit{UML class diagram showing NotificationController, NotificationService, and template system}\\
\vspace{0.5cm}
\textit{Dimensions: 12" x 10"}\\
\vspace{0.5cm}
...
% Placeholder for notification sequence diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{Notification Processing Sequence Diagram}\\
\vspace{0.5cm}
\textit{Sequence diagram showing notification creation, scheduling, and delivery process}\\
\vspace{0.5cm}
\textit{Dimensions: 14" x 8"}\\
\vspace{0.5cm}
\textit{Generated from: notification\_sequence.mermaid}\\
\vspace{2cm}
\end{minipage}
}
...
% Placeholder for ARV treatment class diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{ARV Treatment Management Class Diagram}\\
\vspace{0.5cm}
\textit{UML class diagram showing ARVTreatmentController, ARVTreatmentService, and related entities}\\
\vspace{0.5cm}
\textit{Dimensions: 10" x 8"}\\
\vspace{0.5cm}
...
% Placeholder for ARV treatment sequence diagram
\begin{figure}[H]
\centering
\fbox{
\begin{minipage}{0.9\textwidth}
\centering
\vspace{2cm}
\textbf{ARV Treatment Creation Sequence Diagram}\\
\vspace{0.5cm}
\textit{Sequence diagram showing ARV treatment creation with medication routine setup}\\
\vspace{0.5cm}
\textit{Dimensions: 12" x 8"}\\
\vspace{0.5cm}
\textit{Generated from: arv\_treatment\_sequence.mermaid}\\
\vspace{2cm}
\end{minipage}
}
...
\centering
\vspace{3cm}
\textbf{HIV Clinic System Architecture}\\
\vspace{0.5cm}
\textit{Complete three-tier system architecture showing React 18.2.0 frontend with component hierarchy, Spring Boot 3.2.0 backend with microservice-style architecture, MS SQL Server database layer, and external service integrations including monitoring and security components}\\
\vspace{0.5cm}
\textit{Dimensions: 16" x 12"}\\
\vspace{0.5cm}
\textit{Generated from: system\_architecture.mermaid}\\
\vspace{3cm}
\end{minipage}
}
...
\vspace{0.5cm}
\textit{Detailed component architecture showing the modular design of frontend React application with UI components, feature modules, and services, backend Spring Boot application with controllers, services, repositories, and entities, plus external service integrations}\\
\vspace{0.5cm}
...
\vspace{0.5cm}
\textit{Physical deployment architecture showing client devices, load balancers, web server clusters, application server clusters, database servers, cache servers, file storage, monitoring infrastructure, and external service integrations across different security zones and network tiers}\\
\vspace{0.5cm}
...
\centering
\vspace{3cm}
\textbf{HIV Clinic Management System - State Transition Diagram}\\
\vspace{0.5cm}
\textit{Comprehensive state lifecycle diagrams showing the state transitions for key system entities including Appointment lifecycle (Requested → Scheduled → Confirmed → In Progress → Completed), ARV Treatment lifecycle (Prescribed → Active → Modified → Completed), User Account lifecycle (Registered → Active → Suspended), Notification lifecycle (Created → Delivered → Read), Privacy Settings, and Session management with proper state validation and transition rules}\\
\vspace{0.5cm}
\textit{Dimensions: 18" x 14"}\\
\vspace{0.5cm}
\textit{Generated from: state\_transition\_diagram.mermaid}\\
\vspace{3cm}
\end{minipage}
}
...
\centering
\vspace{3cm}
\textbf{HIV Clinic Management System - Network Architecture Diagram}\\
\vspace{0.5cm}
\textit{Detailed network topology showing security zones (DMZ, Web Tier, Application Tier, Data Tier, Management Tier), network subnets and IP ranges, load balancers, firewalls, intrusion detection systems, VPN access, monitoring infrastructure, and external service integrations with proper security controls, encryption protocols, and network segmentation for HIPAA compliance}\\
\vspace{0.5cm}
\textit{Dimensions: 20" x 16"}\\
\vspace{0.5cm}
\textit{Generated from: network\_architecture.mermaid}\\
\vspace{3cm}
\end{minipage}
}
\caption{Network Architecture and Security Zones}
\label{fig:network-architecture-diagram}
\end{figure}
