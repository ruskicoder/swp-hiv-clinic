...
\centering
\vspace{1.5cm}
\textbf{Patient Login Screenshot}\\
\vspace{0.5cm}
\textit{Login form with username/password fields and authentication options}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Patient Registration Screenshot}\\
\vspace{0.5cm}
\textit{Registration form with personal information fields}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Appointment Booking Screenshot}\\
\vspace{0.5cm}
\textit{Doctor selection, date/time picker, and confirmation}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Patient Dashboard Screenshot}\\
\vspace{0.5cm}
\textit{Shows upcoming appointments, medication reminders, and navigation}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Medical Records Screenshot}\\
\vspace{0.5cm}
\textit{Medical history, treatment information, and privacy settings}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Doctor Availability Management Screenshot}\\
\vspace{0.5cm}
\textit{Calendar view, time slot creation, and schedule management}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Doctor Dashboard Screenshot}\\
\vspace{0.5cm}
\textit{Shows daily appointments, patient notifications, and availability management}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Doctor Patient View Screenshot}\\
\vspace{0.5cm}
\textit{Patient details, medical history, and treatment management}\\
\vspace{1.5cm}
\end{minipage}
}
...
\centering
\vspace{1.5cm}
\textbf{Doctor Treatment Management Screenshot}\\
\vspace{0.5cm}
\textit{ARV treatment planning and monitoring}\\
\vspace{1.5cm}
\end{minipage}
}
